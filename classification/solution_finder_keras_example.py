...
models = [
        ("KerasNN_15l_36n_or_iu_lm_d2" , 'KerasNN_not_fitted(n_layers=15, n_neurons=36, optimizer="adam",init="uniform",loss="mean_squared_error",r_dropout=0.2)')
]
...
samplers =  [
    ...
    ("RandomOverSampler_0.35", RandomOverSampler(random_state=42, ratio=0.35)),
