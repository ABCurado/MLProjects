...
def GS_GP(population_size=1000, generations=20, tournament_size=20, stopping_criteria=0.0,
          ...
          function_probs=True, probabilistic_operators=False, probabilistic_phenotype_operators=False):
    est_gp = SymbolicRegressor(population_size=population_size,
                               ...
                               function_probs=function_probs,probabilistic_operators=probabilistic_operators,
